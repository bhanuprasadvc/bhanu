...
const MyProfile = () => {
   ...
   const { id } = useParams()
   const payload1 = { college_id:1000}
   useEffect(() => {
       axios.get("http://freshmentmodules.governmentjobsforgraduates.com/api/freshment_portal_apis/College/get_college_profile", { params: payload1 }, {
           headers: {
				...
				<div className="col-xl-12">
					...
					<div className="profile-pic d-flex">
						...
						<div className="profile-info2">
							<h2 className="mb-0">{collegeData.college_name}</h2>
							<h4>{collegeData.tpo_name}</h4>
							<span className="d-block"><i className="fas fa-map-marker-alt me-2"></i>{collegeData.college_address}</span>
						</div>
					</div>
				</div>
						...
						<div className="col-xl-8 col-xxl-7">
							<div className="card">
								...
								<div className="card-body">
									...
									<h4 className="fs-20 font-w600 my-4">TPO Information</h4>
									...
									<div className="d-flex contacts-social align-items-center mb-3  me-sm-5 me-0">
											...
											<div>
												<span>Name</span>
												<h5 className="mb-0 fs-18">{collegeData.tpo_name}</h5>
											</div>
										</div>
										<div className="d-flex contacts-social align-items-center mb-3  me-sm-5 me-0">
											<span className="me-3">
											...
											<div>
												<span>Phone</span>
												<h5 className="mb-0 fs-18">{collegeData.college_contact_no}</h5>
											</div>
										</div>
										<div className="d-flex contacts-social align-items-center mb-3">
											...
											<div>
												<span>Email</span>
												<h5 className="mb-0 fs-18">{collegeData.college_email}</h5>
											</div>
										</div>
									</div>	
								</div>
