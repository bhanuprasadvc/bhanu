                    ...
                    <div className="card">
                            ...
                            <div className="col-md-4 col-12 text-end">    
                                ...
                                <div className="mt-3">
                                    ...
                                    <div className="progress ">
                                        <div className="progress-bar bg-danger progress-animated" st yle={{width: "85%", height:"6px"}} role="progressbar">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <div className="row">
                                <div className="col-xl-6 col-md-6">
                                    ...
                                    <p className="font-w600 mb-2 d-flex"><span className="custom-label-2">Placed Company : </span><span className="font-w400">Abcd pvt Ltd</span></p>
                        ...
                        <div className="card-footer d-flex flex-wrap justify-content-between">
                            ...
                            <div>
                                ...
                                <Link to={"#"} className="btn btn-warning btn-md me-2 mb-2"><i className="far fa-envelope me-2"></i>Email</Link>
