       ...
       <div className="mt-4 d-flex justify-content-between align-items-center flex-wrap">
         ...
         <div className="d-flex align-items-center mb-4">
           <div className="default-tab job-tabs">
             ...
             {/* <button type="button" onCl ick={()=> setAddCard(false)} className="btn btn-danger"> <i className="flaticon-delete-1"></i> Discard</button>       */}
           </div>
           {/* <div>    
                            <Dropdown className="default-select">
                                ...
                                <Dropdown.Menu className="dropdown-menu dropdown-menu-end mt-1">
                                    <Dropdown.Item className="text-primary" eventKey="List1" onCl ick={()=>setSelectblog("Newest")}>
                                        Newest
                                    </Dropdown.Item>
                                    <Dropdown.Item className="text-primary" eventKey="Boxed" onCl ick={()=>setSelectblog("Oldest")}>
                                        Oldest
                                    </Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
         ...
         <Tab.Pane eventKey="Boxed">
           <div className="row">
             {jobList.map((data, index) => (
               <div
                 className="col-xl-3 col-xxl-4  col-md-4 col-sm-6"
                 key={index}
               >
                 <div className="card">
                   <div className="jobs2 card-body text-center">
                     <div className="text-center">
                       ...
                       <h4 className="fs-20 mb-0">{data.category_name}</h4>
                     ...
                     <div>
                       ...
                       <span>
                         <i className="fas fa-comments-dollar me-2"></i>$ 2,000
                         - $ 2,500
                       </span>
                     </div>
                   </div>
